 ...
 *
 * @param {string} name - The name of the professional user.
 * @param {string} email - The email address of the professional.
 * @param {string} password - The temporary password for the professional.
 * @param {string} trialEndDate - The formatted trial end date.
 * @returns {string} The HTML string containing the formatted welcome email.
 */
export const professionalWelcomeEmailTemplate = (
  name: string,
  email: string,
  password: string,
  trialEndDate: string
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    ...
                                                                                    Hi <strong
                                                                                        style="font-weight: 600;word-break: break-all;">${name},</strong>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="vertical-align: top;"
                                                                            ...
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="vertical-align: top; font-family: 'Montserrat', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 1.42; letter-spacing: -0.4px; color: #424242; padding: 0 20px; ">
                                                                                    Your professional account has been successfully created! We're excited to have you join our platform.
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="vertical-align: top;"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="padding-top: 20px;">
                                                                                                    <table border="0" cellpadding="0"
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td style="font-size: 14px; color: #424242; text-align: left; padding: 10px 0;">
                                                                            ...
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="vertical-align: top; font-family: 'Montserrat', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600; line-height: 1.42; letter-spacing: -0.4px; color: #424242; padding: 0 20px;">
                                                                            ...
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="vertical-align: top; font-family: 'Montserrat', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 1.42; letter-spacing: -0.4px; color: #424242; padding: 0 20px;">
                                                                                    Your 30-day trial period has started and will end on <strong>${trialEndDate}</strong>. During this time, you'll have full access to all professional features.
                                                                                </td>
                                                                            </tr>
