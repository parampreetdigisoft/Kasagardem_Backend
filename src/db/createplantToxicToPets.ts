    ...
    try {
        const query=`
            CREATE TABLE IF NOT EXISTS plant_toxic_to_pets (
                ...
                popular_name_en  VARCHAR(255) NOT NULL,
                popular_name_pt VARCHAR(255) NOT NULL,
                scientific_name VARCHAR(255) NOT NULL,
                family VARCHAR(255) NOT NULL,
                other_names varchar(225) NOT NULL,
                toxic_dogs varchar(255) NOT NULL,
                toxic_cats varchar(255) NOT NULL,
                toxic_hourse varchar(255) NOT NULL,
                pet_friendly varchar(255) NOT NULL,
                severity VARCHAR(255) NOT NULL,
                severity_source VARCHAR(255) NOT NULL,
                toxic_principle VARCHAR(255) NOT NULL,
                toxic_principle_pt VARCHAR(255) NOT NULL,
                clinical_symptoms VARCHAR(255) NOT NULL,
                clinical_symptoms_pt VARCHAR(255) NOT NULL,
